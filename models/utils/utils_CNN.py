...
def save_checkpoint_2(state, is_best, save_path, filename, flag=None):
    torch.save(state, os.path.join(save_path,filename))
    if is_best:
        shutil.copyfile(os.path.join(save_path,filename), os.path.join(save_path, flag + '_model_best.pth'))
